...
void usage(void) {
    fprintf(stdout, "check_mqtt version %s\n"
            ...
            "   [--key=<key>] [--ca=<ca>] [--cadir=<dir>] [--insecure] [--qos=<qos>] \n"
            "   [--topic=<topic>] [--timeout=<sec>] [--ssl] [--user=<user>] \n"
            "   [--password=<pass>] [--warn=<ms>] [--critical=<ms>] [--keepalive=<s>]\n"
            "\n"
            "   --help              This text\n"
            "\n"
            ...
            "\n"
            "   --cadir=<dir>       Use <dir> as directory containing CA certificates\n"
            "\n"
